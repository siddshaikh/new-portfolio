    ...
    <section className="hero-container">
      <div className="hero-content">
        ...
        <p>
          ...
          DELIGHTFUL AND INTUITIVE DIGITAL EXPERIENCES. WITH A STRONG FOUNDATION
          IN CODING PRINCIPLES AND A KEEN EYE FOR DETAIL, I SPECIALIZE IN
          TRANSLATING COMPLEX IDEAS INTO USER-FRIENDLY INTERFACES THAT CAPTIVATE
          AND ENGAGE.
        </p>
      </div>
          ...
          <div className="tech-icon">
            <span>
              <FaPython
                className="icon"
                size={`${screenWidthForIcon < 600 ? "1.5rem" : "3rem"}`}
                style={{ color: "#306998" }} // Python color (blue)
              />
            </span>
          </div>
        </div>
